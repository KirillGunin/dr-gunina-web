<template>
    <div class="privacy-policy">
        ...
        <p>
            ...
            по обеспечению безопасности персональных данных, предпринимаемые Гунина Ксения
        ...
        <p>
            ...
            веб-сайта <a href="https://drgunina.tilda.ws/">https://drgunina.tilda.ws/</a>.
        </p>
        ...
        <p>
            ...
            сетевому адресу <a href="https://drgunina.tilda.ws/">https://drgunina.tilda.ws/</a>.
        </p>
        <p>
        ...
        <p>
            2.8. <strong>Персональные данные</strong> — любая информация, относящаяся прямо или
            косвенно к определенному или определяемому Пользователю веб-сайта
            <a href="https://drgunina.tilda.ws/">https://drgunina.tilda.ws/</a>.
        </p>
        <p>
            2.9.
            <strong
        ...
        <p>
            ...
            актуализировать их самостоятельно, путем направления Оператору уведомления на адрес
            электронной почты Оператора
            <a href="mailto:dr.kseniagunina@yandex.ru">dr.kseniagunina@yandex.ru</a> с пометкой
        ...
        <p>
            ...
            Политикой конфиденциальности. Оператор не несет ответственность за действия третьих лиц,
        ...
        <p>
            ...
            адресу
            <a href="https://drgunina.tilda.ws/privacy">https://drgunina.tilda.ws/privacy</a>.
        </p>
    </div>
</template>
